...
@section('content')
<div class="padre">
    <h2 class="hijo">Crear Nueva Orden de Trabajo</h2>
</div>
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <form action="{{route('ordentrabajo.store')}}" enctype="multipart/form-data" method="POST" novalidate>
            @csrf
            <div class="form-group">
                ...
                <input type="text" name="maquina" class="form-control @error('maquina') is-invalid @enderror"
                    id="maquina" placeholder="Nombre de la maquina" value={{old('maquina')}}>
                @error('maquina')
            ...
            <div class="form-group">
                ...
                <input type="text" name="area" class="form-control @error('area') is-invalid @enderror" id="area"
                    placeholder="Area de la maquina" value={{old('area')}}>
                @error('area')
                <span class="invalid-feedback d-block" role="alert"><strong>{{$message}}</strong></span>
                @enderror
            </div>
            ...
            <div class="form-group">
                {{-- Tipo de trabajo a la Maquina en la orden de trabajo --}}
                <label for="trabajo">Tipo de trabajo:</label>
                <input type="text" name="trabajo" class="form-control @error('trabajo') is-invalid @enderror" id="trabajo"
                    placeholder="Mecánico, Eléctrico, Neumático, Hidráulico u otros" value={{old('trabajo')}}>
                @error('trabajo')
                <span class="invalid-feedback d-block" role="alert"><strong>{{$message}}</strong></span>
                @enderror
            </div>
            <div class="form-group">
                {{-- Total de horas de paro en la Maquina de la orden de trabajo --}}
                ...
                <input type="text" name="horas" class="form-control @error('horas') is-invalid @enderror" id="horas"
                    placeholder="Total de horas de paro" value={{old('horas')}}>
                @error('horas')
                <span class="invalid-feedback d-block" role="alert"><strong>{{$message}}</strong></span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input id="causa" type="hidden" name="causa" value="{{old('causa')}}">
            ...
            <div class="form-group">
                ...
                <input id="solucion" type="hidden" name="solucion" value="{{old('solucion')}}">
            ...
            <div class="form-group">
                ...
                <input id="refacciones" type="hidden" name="refacciones" value="{{old('refacciones')}}">
            ...
            <div class="form-group">
                ...
                <input id="observaciones" type="hidden" name="observaciones" value="{{old('observaciones')}}">
            ...
            <div class="form-group">
                {{-- Fecha de finalizacion de la orden de trabajo --}}
                ...
                <input type="text" name="fecha" class="form-control @error('fecha') is-invalid @enderror" id="fecha"
                    placeholder="Ejemplo: 26-11-2021" value={{old('fecha')}}>
                @error('fecha')
                <span class="invalid-feedback d-block" role="alert"><strong>{{$message}}</strong></span>
                @enderror
            </div>
            <div class="form-group">
                {{-- Imagen representativa de la orden de trabajo --}}
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Agregar Orden de Trabajo">
            </div>
        </form>
    </div>
</div>
