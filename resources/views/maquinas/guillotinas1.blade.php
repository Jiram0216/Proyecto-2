...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{ url('/images/G01_1.PNG')}}" alt="Guillotina G01" class="producto__imagen mt-3">
            <p class="maquina__texto"> Las cizallas de guillotina para metales son 
                máquinas utilizadas para operaciones de corte de metales (hierro, 
                acero, aluminio, etc.) de espesores hasta 25 mm. y con una velocidad 
                de corte de hasta 120 golpes por minuto.

                El corte es efectuado por una estampa de corte formada por dos 
                cuchillas, las cuales disponen normalmente de cuatro ángulos de 
                corte.
                
                La cuchilla inferior va sujeta a la mesa y la superior, bien a 
                la corredera si se trata de cizallas de guillotina con cuello de 
                cisne o al puente porta-cuchillas si son cizallas sin cuello de cisne.
                 </p>
        </article>
        <aside class="asidebar1">
            ...
            <ul class="lista">
                <li class="btn btn-outline-dark btn-block mt-3 text-uppercsae font-weight-bold">1.-Marca: Titán</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercsae font-weight-bold">2.-Modelo: GHE10B20</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercsae font-weight-bold">3.-Serie: N°0811</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercsae font-weight-bold">4.-Capacidad: 3 T/cm3"</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercsae font-weight-bold">5.-Garganta: 10 ft</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercsae font-weight-bold">6.-Potencia: Motor 3 HP</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercsae font-weight-bold">7.-Voltaje: 220 voltios</li>
                </ul>
        </aside>
        <article class="maquina">
            <div class="padre">
            ...
            <img src="{{ url('/images/G01_2.PNG')}}" alt="Guillotina G01" class="producto__imagen mt-3">
            <div class="container">
