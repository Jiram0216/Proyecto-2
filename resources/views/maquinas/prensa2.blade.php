...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{ url('/images/P02_1.PNG')}}" alt="Prensa P02" class="producto__imagen mt-3">
        ...
        <aside class="asidebar1">
            ...
            <ul class="lista">
                <li class="btn btn-outline-dark btn-block mt-3 text-uppercase font-weight-bold">1.-Marca: Allstel Press</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">2.-Modelo: N°972208</li>
        ...
        <article class="maquina">
            ...
            <img src="{{ url('/images/P02_2.PNG')}}" alt="Prensa P02" class="producto__imagen mt-3">
            <img src="{{ url('/images/P02_3.PNG')}}" alt="Prensa P02" class="producto__imagen mt-2">
        </article>
        <aside class="asidebar1">
            <div class="padre">
                <h2 class="hijo">Componentes</h2>
