...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{ url('/images/COMP4_01.PNG')}}" alt="COMP4_01" class="producto__imagen mt-3">
        </article>
        <aside class="asidebar1">
            ...
            <ul class="lista">
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">6.-Cabeza: 2hp</li>
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">9.-Modelo: 220v</li>
        ...
        <article class="maquina">
            ...
            <img src="{{ url('/images/COMP4_02.PNG')}}" alt="COMP4_02" class="producto__imagen mt-3">
