...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{ url('/images/COMP1_01.PNG')}}" alt="COMP1_01" class="producto__imagen mt-3">
        </article>
        <aside class="asidebar1">
            ...
            <ul class="lista">
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">5.-Capacidad: 120 psi</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">6.-Cabeza: 15hp</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">7.-Tanque: 500 Litros</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">8.-Marca: Evans</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">9.-Modelo: VCE460 220v</li>
        ...
        <article class="maquina">
            ...
            <img src="{{ url('/images/COMP1_02.PNG')}}" alt="Troquel T01" class="producto__imagen mt-3">
