...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{ url('/images/COMP2_01.PNG')}}" alt="COMP2_01" class="producto__imagen mt-3">
        </article>
        <aside class="asidebar1">
            ...
            <ul class="lista">
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">5.-Capacidad: 135 psi</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">6.-Cabeza: 5hp</li>
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">9.-Modelo: VT631403J 220v</li>
        ...
        <article class="maquina">
            ...
            <img src="{{ url('/images/COMP2_02.PNG')}}" alt="COMP2_02" class="producto__imagen mt-3">
