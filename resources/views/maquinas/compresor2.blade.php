...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="img/img1.jpg" alt="Compresor C2" class="producto__imagen">
        ...
        <article class="maquina">
            ...
            <img src="img/img2.jpg" alt="Compresor C2" class="producto__imagen margin">
...
<footer class="contenido--pie">
    <div class="contenido--pie__text contenedor">
        <a class="btn btn-outline-primary mt-2 text-uppercsae font-weight-bold" href="{{route('maquinas.planta1')}}"><h2>Regresar</h2></a>
    </div>
