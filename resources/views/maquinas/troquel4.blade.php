...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{ url('/images/T04_1.png')}}" alt="Troquel T04" class="producto__imagen mt-3">
        ...
        <aside class="asidebar1">
            ...
            <ul class="lista">
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">5.-Clutch Neumático</li>
        ...
        <article class="maquina">
            ...
            <img src="{{ url('/images/T04_2.png')}}" alt="Troquel T04" class="producto__imagen mt-3">
        </article>
        <aside class="asidebar1">
            <div class="padre">
