...
<main class="contenedor contenido--principal">
    <div class="grid2">
        <article class="maquina">
            ...
            <img src="{{url('/images/L01_1.PNG')}}" alt="Laser L01" class="producto__imagen mt-3">
        ...
        <aside class="asidebar1">
            ...
            <ul class="lista">
                ...
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">2.-Modelo: LF1325L No.
                    Serie 27779</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">3.-Mesa: 1.30 x 2.50 mts
                </li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">4.-Calibre: 24, 22, 20,
                    18, 16, 14, 12, 11, 1/8", 10, 9, 8, 7, 3/16"</li>
                <li class="btn btn-outline-dark btn-block mr-2 text-uppercase font-weight-bold">5.-Voltaje: 500W / 220 Volts
                </li>
            </ul>
        </aside>
        <article class="maquina">
